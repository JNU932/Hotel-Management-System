...
public:
    ...
    //添加一种食材
    static void AddMaterial(const string& name, int num);
    //添加多种食材
    static void AddMaterial(const map<string,int>& Materials);
    //消耗一种食材
    static void TakeMaterial(const string& name, int num);
    //消耗多种食材
    static void TakeMaterial(const map<string,int>& Materials);
    //查询食材数量
